...
st.markdown(
    ...
    :root {
        ...
        --panel-3: #1c1f18;
        --line: #34372c;
        --line-soft: rgba(183,155,97,.20);
        --gold: #b79b61;
        --gold-soft: #d7c18d;
        --ivory: #eee7d7;
        --muted: #9d9b8f;
        --green: #718a73;
        --green-soft: rgba(113,138,115,.14);
        --red: #90605a;
        --red-soft: rgba(144,96,90,.13);
        --blue-soft: rgba(93,123,145,.12);
    }
    ...
    .stApp {
        background:
            radial-gradient(circle at 80% 4%, rgba(183,155,97,.07), transparent 28%),
            linear-gradient(180deg, #0b0c0a 0%, #0e100c 100%);
        color: var(--ivory);
    }
    ...
    .rule {
        margin: 20px 0 26px;
        height: 1px;
        background: linear-gradient(90deg, var(--gold), rgba(183,155,97,.18), transparent);
    }
    ...
    .notice {
        ...
        background: rgba(183,155,97,.045);
        color: #c6c0ae;
        font-size: 12px;
        line-height: 1.65;
        margin: 18px 0;
    ...
    .metric-observation {
        margin-top: 11px;
        padding-top: 10px;
        border-top: 1px solid rgba(183,155,97,.12);
        color: #cfc8b6;
        font-size: 11px;
        line-height: 1.58;
    }
    ...
    .obs-badge.risk { color: #b77c73; border-color: rgba(183,124,115,.35); }
    ...
    .lab-hero {
        ...
        background:
            radial-gradient(circle at 100% 0%, rgba(183,155,97,.12), transparent 38%),
            rgba(18,20,15,.9);
        padding: 25px 26px;
        margin: 14px 0 17px;
    }
...
def plot_history(frame: pd.DataFrame, column: str, title: str, y_prefix: str = "") -> None:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            y=series.values,
            mode="lines+markers",
            line=dict(color="#b79b61", width=2),
            marker=dict(size=6, color="#d7c18d"),
    ...
    fig.update_layout(
        ...
        font=dict(color="#eee7d7", family="Inter"),
        margin=dict(l=10, r=10, t=48, b=10),
        xaxis=dict(showgrid=False),
        yaxis=dict(gridcolor="rgba(183,155,97,.10)", zeroline=False),
        hoverlabel=dict(bgcolor="#171913", font_color="#eee7d7"),
    )
        ...
        if share_price is None or share_price <= 0:
            ...
            fig.add_trace(
                go.Bar(
                    ...
                    y=scenario_values,
                    marker_color=["#90605a", "#b79b61", "#718a73"],
